...
SWIFT_CLASS("_TtC8Smashtag27CoreDataTableViewController")
@interface CoreDataTableViewController : UITableViewController <NSFetchedResultsControllerDelegate>
@property (nonatomic, strong) NSFetchedResultsController * _Nullable fetchedResultsController;
...
SWIFT_CLASS("_TtC8Smashtag9TweetInfo")
@interface TweetInfo : NSManagedObject
...
@interface TweetInfo (SWIFT_EXTENSION(Smashtag))
@property (nonatomic, strong) NSDate * _Nullable posted;
@property (nonatomic, copy) NSString * _Nullable text;
@property (nonatomic, copy) NSString * _Nullable unique;
@property (nonatomic, strong) TwitterUser * _Nullable tweeter;
@end
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified tweetScreenNameLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified tweetTextLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified tweetCreatedLabel;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified tweetProfileImageView;
...
- (IBAction)refreshTweets:(UIRefreshControl * _Null_unspecified)sender;
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section;
...
SWIFT_CLASS("_TtC8Smashtag27TweetersTableViewController")
@interface TweetersTableViewController : CoreDataTableViewController
@property (nonatomic, copy) NSString * _Nullable mention;
@property (nonatomic, strong) NSManagedObjectContext * _Nullable managedObjectContext;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
- (nonnull instancetype)initWithStyle:(UITableViewStyle)style OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC8Smashtag11TwitterUser")
...
@interface TwitterUser (SWIFT_EXTENSION(Smashtag))
@property (nonatomic, copy) NSString * _Nullable name;
@property (nonatomic, copy) NSString * _Nullable screenName;
@property (nonatomic, strong) NSSet * _Nullable tweets;
@end
